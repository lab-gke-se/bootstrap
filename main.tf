...
module "folders" {
  ...
  source       = "github.com/lab-gke-se/modules//resources/folder"
...
module "projects" {
  ...
  source          = "github.com/lab-gke-se/modules//resources/project"
...
module "service_accounts" {
  ...
  source       = "github.com/lab-gke-se/modules//iam/service_account"
...
module "org_roles" {
  ...
  source      = "github.com/lab-gke-se/modules//iam/role/organization"
...
module "prj_roles" {
  ...
  source      = "github.com/lab-gke-se/modules//iam/role/project"
